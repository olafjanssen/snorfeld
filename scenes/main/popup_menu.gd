...
func _ready():
	...
	# Analysis submenus
	_add_analysis_submenu("Grammar", RUN_ALL_GRAMMAR_ANALYSES_ID,
		RUN_CHAPTER_GRAMMAR_ANALYSES_ID, CLEAR_GRAMMAR_CACHE_ID)
	_add_analysis_submenu("Style", RUN_ALL_STYLE_ANALYSES_ID,
		RUN_CHAPTER_STYLE_ANALYSES_ID, CLEAR_STYLE_CACHE_ID)
	_add_analysis_submenu("Structure", RUN_ALL_STRUCTURE_ANALYSES_ID,
		RUN_CHAPTER_STRUCTURE_ANALYSES_ID, CLEAR_STRUCTURE_CACHE_ID)
	_add_analysis_submenu("Character", RUN_ALL_CHARACTER_ANALYSES_ID,
		RUN_CHAPTER_CHARACTER_ANALYSES_ID, CLEAR_CHARACTER_CACHE_ID)
	_add_analysis_submenu("Object", RUN_ALL_OBJECT_ANALYSES_ID,
		RUN_CHAPTER_OBJECT_ANALYSES_ID, CLEAR_OBJECT_CACHE_ID)
	add_separator()
